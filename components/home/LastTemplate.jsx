            ...
            <div>
                ...
                <div className="items-center p-10 mx-auto bg-gray-100 rounded-md dark:bg-slate-800 md:flex space-between dark:ring-1 dark:ring-white/10 dark:ring-inset">
                    <div className="p-5 md:w-1/2">
                        <h2 className="mb-4 text-3xl font-semibold dark:text-gray-200">Finance Tracker</h2>
                        <p className="mb-4 text-gray-600 dark:text-gray-400">A complete digital system to capture & organize all your knowledge, projects, notes, goals, and more.</p>
                        <Link href="/">
