    ...
    return (
        <section className="container mx-auto max-w-7xl">
            <div className="items-center justify-center block py-20 lg:flex">
                <div className="px-10">
                    <div>
                        <img className="block mx-auto w-28 h-28 md:w-48 md:h-48" src="/images/avatar.jpg" alt="Alejandro's Photo" />
                    </div>
                </div>
                <div className="px-10 text-center md:text-left">
                    <h1 className="mb-3 text-3xl font-bold md:text-4xl">Alejandro Vivas</h1>
                    <p className="mb-5"> <span className="text-gray-400">Software Engineer at</span>  <a target="_blank" rel="noreferrer" href="https://carsales.com.au/" className="font-semibold text-gray-900 hover:underline" >Carsales.com Limited</a></p>
